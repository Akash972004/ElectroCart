    ...
    return (
        <div className="w-full py-4">
            <div className="relative flex items-center justify-between w-full">
                ...
                <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-full h-1 bg-gray-200 dark:bg-slate-700 -z-10 rounded-full" />
                ...
                {steps.map((step, index) => {
                    ...
                    return (
                        <div key={step.id} className="flex flex-col items-center">
                            <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center border-2 transition-all duration-300 z-10 bg-white dark:bg-slate-900 ${isActive
                            ...
                            <span
                                className={`mt-2 text-xs font-medium transition-colors duration-300 absolute -bottom-6 w-20 text-center ${isActive ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400'
                                    }`}
                            >
                                {step.label}
                            </span>
