...
const Categories = () => {
  ...
  return (
    <section id="categories-section" className="py-16 bg-white dark:bg-slate-900 transition-colors duration-300">
        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center space-x-2 mt-12">
            <Button
              ...
              className="rounded-full w-10 h-10 border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 disabled:opacity-50"
            >
