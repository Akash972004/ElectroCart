      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/3 space-y-6">
            <Card className="overflow-hidden border border-gray-200 dark:border-gray-700 dark:bg-black shadow-md">
              ...
              <div className="px-6 pb-6">
                <div className="relative flex justify-center -mt-12 mb-4">
                  <Avatar className="h-24 w-24 border-4 border-white dark:border-black shadow-lg">
                    ...
                    />
                    <AvatarFallback className="text-2xl font-bold bg-gray-100 dark:bg-gray-800">
                      {user.name.charAt(0)}
                    </AvatarFallback>
                  </Avatar>
                </div>
            ...
            <Card className="border border-gray-200 dark:border-gray-700 dark:bg-black shadow-sm">
              <CardHeader>
          ...
          <div className="flex-1 space-y-6">
            <Card className="border border-gray-200 dark:border-gray-700 dark:bg-black shadow-sm relative">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-1">
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-medium h-8 flex items-center">
                        {user.name}
                      </p>
                    )}
                  </div>
                  <div className="space-y-1">
                    ...
                    <p className="font-medium h-8 flex items-center text-gray-500">
                      {user.email}
                    </p>
                  </div>
                  <div className="space-y-1">
            ...
            <Card className="border border-gray-200 dark:border-gray-700 dark:bg-black shadow-sm">
              ...
              <CardContent>
                <div className="flex items-start gap-4 p-4 rounded-lg border border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
